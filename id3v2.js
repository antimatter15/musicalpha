//TODO: replace this with the probably superior https://github.com/aadsm/JavaScript-ID3-Reader
//I'd like to pretend that I'm using this because I'm already familiar with the code 
//and some other pretext, but truthfully, it's probably not-invented-here-syndrome
//my code is terrible but i'm still using it because it's my code. yeah MINE.
//Not really, if anyone ever reads this code and wants to improve the project, hack aadsm's
//code to use the File API instead of that weird BinaryAjax stuff and replace this hunk
//of useless stuff with that.
